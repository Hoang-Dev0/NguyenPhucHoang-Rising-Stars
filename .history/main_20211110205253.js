...
function removeTodo(element) {
  ...
  console.log(
    "🚀 ~ file: main.js ~ line 61 ~ element.dataset.index",
    parseelement.getAttribute("data-index")
  );

  //   LIST.splice(element.dataset.index, 1);

  const indexOfItem = element.data - index;
  LIST = LIST.filter((element, index) => element.id !== indexOfItem);
}
